...
const OrderProductCard = ({ orders, singleInfo, setSingleInfo, handleCancelOrder }) => {
  ...
  return (
    <>
      {orders?.map((data, i) => {
        return (
          <div className="flex w-full bg-white border lg:h-[130px] gap-1" key={i}>
            <div className="w-1/3">
              <img
                width={"auto"}
                height={"auto"}
            ...
            <div className="w-2/3 lg:w-full p-2 flex flex-col justify-between">
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-3 mt-2 lg:mt-0">
                  <OrderCardButton func={() => singleOrderHandler(data)} text={"Order Info"} display />

                  <OrderCardButton func={() => singleOrderHandler(data)} text={"Order Info"} />
