...
import { deleteOrder } from "../../../utils/Orders.js";
...
const DeleteOrderModal = () => {
  ...
  const deleteOrderHandler = async () => {
    try {
      ...
      if (res?.status === 200) {
        state.showDeleteOrderModal = false;
          ...
          <div className="relative bg-white rounded-lg shadow w-full">
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="w-full flex items-center justify-center pt-6">
                <button
                  className="cButton"
                  onClick={() => (state.showDeleteOrderModal = false)}
                >
                  No
                </button>
                <button className="dButton" onClick={deleteOrderHandler}>
                  Yes
                </button>
              </div>
            </div>
