...
<iframe src="https://fast.wistia.net/embed/iframe/f6b9mxb3iu?seo=false&videoFoam=true" title="C0910 -Startup Academy - AD Video" allow="autoplay; fullscreen" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" msallowfullscreen width="100%" height="100%"></iframe>
</div></div>
<script src="https://fast.wistia.net/assets/external/E-v1.js" async></script> */}
          ...
          >
            {playVideo && (
              <iframe
                ...
                width="100%"
                height="100%"
                src="https://fast.wistia.net/embed/iframe/f6b9mxb3iu?seo=false&videoFoam=true"
                // allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"

                // allowfullscreen
                // className="rounded-none w-2/3 !h-full object-cover"
            ...
            {!playVideo && (
              <div className="h-full relative">
                <img
                  src={
                    "https://course.socialseller.in/socialseller/src/assets/img/thumb.png"
                  }
                  alt="img"
          ...
          <div className="w-full md:w-1/2 text-center md:text-left flex flex-col items-start h-full justify-start">
            <h2 className="text-3xl md:text-4xl tracking-wider font-normal leading-9 mb-4 text-white max-w-[570px]">
              Courses That Help You Create{" "}
              <span className="font-semibold">Your Online Business</span>
            </h2>
